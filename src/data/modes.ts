...
export const MODES = [
  ...
  { id: 'adult' as const, title: '18+', emoji: '🔥', icon: 'fire', image: IMAGES.adultMode.png, description: 'Страсть • Желания\nОткровенность' },
  { id: 'psychology' as const, title: 'Внутренний мир', emoji: '🧠', icon: 'brain', image: IMAGES.psychologyMode.png, description: 'Эмоции • Честность\nРефлексия' },
